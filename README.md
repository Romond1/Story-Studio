...
## Build version
- Current iteration: **V5**
- The app shows this build marker in the header and in the bottom-right of Project Status so installed builds can be matched to GitHub notes.
